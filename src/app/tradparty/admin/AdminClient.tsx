        ...
        <div>
          <div style={{ 
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2em', fontWeight: 'bold', color: '#8B4513' }}>{stats.total}</div>
            ...
            <table style={{ borderCollapse: "collapse", width: "100%", background: 'white', borderRadius: 8 }}>
              <thead>
                <tr style={{ background: '#F5DEB3' }}>
                  <th style={{ textAlign: "left", borderBottom: "2px solid #DAA520", padding: 12 }}>Name</th>
                  <th style={{ textAlign: "left", borderBottom: "2px solid #DAA520", padding: 12 }}>Phone</th>
                  <th style={{ textAlign: "left", borderBottom: "2px solid #DAA520", padding: 12 }}>RSVP</th>
                  <th style={{ textAlign: "left", borderBottom: "2px solid #DAA520", padding: 12 }}>WhatsApp</th>
                  <th style={{ textAlign: "left", borderBottom: "2px solid #DAA520", padding: 12 }}>Updated</th>
                </tr>
              </thead>
              <tbody>
